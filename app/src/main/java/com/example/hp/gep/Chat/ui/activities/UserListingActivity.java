package com.example.hp.gep.Chat.ui.activities;
...
import com.example.hp.gep.Chat.core.logout.LogoutContract;
import com.example.hp.gep.Chat.core.logout.LogoutPresenter;
import com.example.hp.gep.Chat.ui.adapters.UserListingPagerAdapter;
...
//        mTabLayoutUserListing = (TabLayout) findViewById(R.id.tab_host);
//        mViewPagerUserListing = (ViewPager) findViewById(R.id.tab_host);
    }
