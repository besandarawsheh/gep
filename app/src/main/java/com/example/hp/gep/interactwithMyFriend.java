...
public class interactwithMyFriend  extends AsyncTask<String,Void,String> {

    Context context;
    AlertDialog alertDialog;
    //constructor
    interactwithMyFriend (Context ctx){
...
//extract epage from params
        ...
        String friendInfo_url="http://192.168.1.108/actionMyFriend.php";
