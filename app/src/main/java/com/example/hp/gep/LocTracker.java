...
public class LocTracker extends AppCompatActivity {

    private static final String TAG = LocTracker.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_loc_tracker);
                    ...
                    public void onReceive(Context context, Intent intent) {
                        ...
                        if (latitude != null && longitude != null) {
                           ...
                           userLocBroadCast.setLatitude(latitude);
                            ...
                            background.execute(userLocBroadCast.getLatitude(),userLocBroadCast.getLongitude(),Email.getEmail());
    ...
    private void promptInternetConnect() {
        AlertDialog.Builder builder = new AlertDialog.Builder(LocTracker.this);
            ...
            showSnackbar(R.string.permission_rationale,
                    android.R.string.ok, new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            // Request permission
                            ActivityCompat.requestPermissions(LocTracker.this,
