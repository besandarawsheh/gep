...
import com.example.hp.gep.Chat.ui.activities.ChatActivity;
import com.example.hp.gep.Chat.ui.adapters.UserListingRecyclerAdapter;
...
public class UsersFragment extends Fragment implements GetUsersContract.View, ItemClickSupport.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View fragmentView = null;//inflater.inflate(R.layout.fragment_users, container, false);
