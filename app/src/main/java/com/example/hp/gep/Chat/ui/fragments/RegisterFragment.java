...
import com.example.hp.gep.Chat.core.users.add.AddUserPresenter;
import com.example.hp.gep.Chat.ui.activities.UserListingActivity;
...
public class RegisterFragment extends Fragment implements View.OnClickListener, RegisterContract.View, AddUserContract.View {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View fragmentView = null;//inflater.inflate(R.layout.fragment_register, container, false);
